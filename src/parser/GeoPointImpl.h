...
#ifndef QLEVER_SRC_PARSER_GEOPOINTIMPL_H
#define QLEVER_SRC_PARSER_GEOPOINTIMPL_H
...
inline GeoPoint::GeoPoint(double lat, double lng) : lat_{lat}, lng_{lng} {
...
// _____________________________________________________________________________
inline GeoPoint::T GeoPoint::toBitRepresentation() const {
...
// _____________________________________________________________________________
inline std::optional<GeoPoint> GeoPoint::parseFromLiteral(
...
// _____________________________________________________________________________
inline GeoPoint GeoPoint::fromBitRepresentation(T bits) {
...
// _____________________________________________________________________________
inline std::string GeoPoint::toStringRepresentation() const {
...
// _____________________________________________________________________________
inline std::pair<std::string, const char*> GeoPoint::toStringAndType() const {
  return std::pair(toStringRepresentation(), GEO_WKT_LITERAL);
};

#endif  // QLEVER_SRC_PARSER_GEOPOINTIMPL_H
